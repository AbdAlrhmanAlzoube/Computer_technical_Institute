...
class DailyScheduleController extends Controller
{
   /**
    ...
    public function create()
    {
        ...
        return view('Admin.Pages.DailySchedule.add_daily_schedule', compact('subjects', 'teachers'));
    }
    ...
    public function edit(DailySchedule $dailySchedule)
    {
        $subjects = Subject::all();
        $teachers = Teacher::all();
        return view('Admin.Pages.DailySchedule.edit_daily_schedule' ,compact('dailySchedule','subjects', 'teachers'));
    }
